...
def do_deploy(archive_path):
    ...
    try:
        ...
        run('sudo tar -xzf /tmp/{} -C /data/web_static/releases/{}'.format(archive_f, archive_d))
        run('sudo rm /tmp/{}'.format(archive_f))
        run('sudo mv /data/web_static/releases/{}/web_static/* /data/web_static/releases/{}'.format(archive_d, archive_d))
        run('sudo rm -rf /data/web_static/releases/{}/web_static/'.format(archive_d))
        run('sudo rm -rf /data/web_static/current')
        run('sudo ln -s /data/web_static/releases/{} /data/web_static/current'.format(archive_d))
        return True
